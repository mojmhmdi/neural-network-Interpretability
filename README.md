In this repository, a novel method (designed by me) for neural networks interpretability is introduced. In this method, a second smaller network is trained such that it can find the corresponding score for each feature. 
